...
import Truck1 from '../../assets/images/nftcollection/1.png'
import Truck2 from '../../assets/images/nftcollection/2.png'
import Truck3 from '../../assets/images/nftcollection/3.png'
...
export default class NFTAsNavFor extends Component {
  constructor(props) {
    super(props);
    this.state = {
      nav1: null,
